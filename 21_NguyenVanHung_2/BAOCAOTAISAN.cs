...
namespace _21_NguyenVanHung_2 {
    ...
    public class BAOCAOTAISAN : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "_21_NguyenVanHung_2.BAOCAOTAISAN.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBAOCAOTAISAN : Component, ICachedReport {
        
        public CachedBAOCAOTAISAN() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            BAOCAOTAISAN rpt = new BAOCAOTAISAN();
            rpt.Site = this.Site;
            return rpt;
        }
